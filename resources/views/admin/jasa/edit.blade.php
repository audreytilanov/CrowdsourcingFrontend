                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{ route('admin.jasa.update', $responseJSON['data']['id']) }}" method="post">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label>Harga</label>
                                    <input type="number" class="form-control" placeholder="Masukkan Harga" value="{{ $responseJSON['data']['harga'] }}" name="harga" required>
                                    @error('harga')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="paketjasa" id="paketjasa" required>
                                        ...
                                        @foreach ( $responsePaketJasa['data'] as $paketjasa)
                                            <option value="{{ $paketjasa['id'] }}" @if($responseJSON['data']['paketjasas']['id'] == $paketjasa['id']) selected @endif>{{ $paketjasa['nama'] }}</option>
                                        @endforeach
                                    </select>
                                    @error('paketjasa')
                                    <span class="text-danger" role="alert">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="kategori" id="kategori" required>
                                        ...
                                        @foreach ( $responseKategori['data'] as $kategori)
                                            <option value="{{ $kategori['id'] }}" @if($responseJSON['data']['kategoris']['id'] == $kategori['id']) selected @endif>{{ $kategori['nama'] }}</option>
                                        @endforeach
                                    </select>
                                    @error('kategori')
                                    <span class="text-danger" role="alert">
